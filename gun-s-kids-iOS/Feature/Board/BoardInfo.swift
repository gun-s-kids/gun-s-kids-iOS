...
struct BoardInfo: Decodable, Identifiable {
    let id = UUID()
    let postNo: Int
    let nickname: String
    ...
    static let sample: [BoardInfo] = [
        ...
        BoardInfo(postNo: 5, nickname: "까만썬그리", companyNm: "현대홈쇼핑", profileImg: "lemon", postTitle: "호이호이호이호이호잏", postContent: "너무너무재밌었어요옹너무너무 재밌었어요", createdDate: "01.12. 14:23", likeCnt: 0, commentCount: 3, postImg: []),
    ]
}
